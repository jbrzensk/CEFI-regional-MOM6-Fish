# Template for the GNU Compiler Collection on a Dell Laptop
#
...
FFLAGS_REPRO =
FFLAGS_DEBUG = -O0 -pg -W -fbounds-check -ffpe-trap=invalid,zero,overflow
...
#LIBS =
LIBS = -L/usr/lib/x86_64-linux-gnu -lnetcdff -Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -Wl,-z,relro -Wl,-z,now -lnetcdf -lnetcdf -lm
